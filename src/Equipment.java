...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        // TODO: finish method
        if(otherEq.getName().equals(name)) {
        	if(otherEq.getCount() == count) {
        		if(otherEq.getTotalWeight() == totalWeight) {
        			if(otherEq.getTotalPrice() == totalPrice) {
        				if(otherEq.getDescription() == description) {
        					return true;
        				}
        			}
        		}
